...
const DICTIONARY: Record<Locale, Messages> = {
  en: {
    ...
    contact: {
      title: "Get in Touch",
      subtitle:
        "Ready to start trading? Our team is here to help you get started with P2P services.",
  ...
  ar: {
    ...
    hero: {
      title1: "شريكك",
      title2: "الموثوق به",
      title3: "في معاملات العملات المشفرة",
      title4: "P2P",
      partner: "شريك",
      p2p: "",
      inWord: "في",
    ...
    contact: {
      title: "تواصل معنا",
      subtitle:
        "جاهز للبدء؟ فريقنا هنا لمساعدتك بخدمات P2P.",
    ...
    faq: {
      ...
      items: [
        { q: "ما هو P2P؟", a: "الـ P2P هو طريقة آمنة يشتري ويبيع فيها المستخدمون العملات المشفرة مباشرة عبر البورصات، مع حماية الضمان (Escrow)." },
  ...
  ru: {
    ...
    hero: {
      ...
      title2: "надежный",
      title3: "партнер в",
      title4: "P2P-криптотрейдинге",
      partner: "партнер",
      p2p: "",
      inWord: "в",
      description:
        "Мы предлагаем удобные, безопасные и прозрачные решения для P2P-сделок через ведущие мировые биржи.",
      cta: "Связаться",
    },
    ...
    about: {
      title: "О нас",
      subtitle: "PEXAH — провайдер P2P‑сделок с базой в Рас‑эль‑Хайме.",
      storyTitle: "О нас",
      storyP1:
        "Наша цель — предоставлять безопасные, быстрые и прозрачные сделки по покупке и продаже криптовалюты через мировые биржи.",
      storyP2:
        "Главная потребность рынка — доверие, и мы обеспечиваем его каждому клиенту.",
      missionTitle: "Наша миссия",
      missionText:
        "Быть надёжным мостом для безопасного и уверенного P2P‑трейдинга.",
      visionTitle: "Наше видение",
      visionText:
        "Стать региональным лидером и признанным доверенным мировым брендом в сфере P2P‑сделок.",
      valuesTitle: "Наши ценности",
      values: [
        { title: "Надёжность", description: "Все сделки прозрачны и зафиксированы." },
        { title: "Скорость", description: "Транзакции завершаются за считанные минуты." },
        { title: "Прозрачность", description: "Комиссии и курсы известны заранее — без скрытых платежей." },
        { title: "Клиентоориентированность", description: "Предлагаем решения, адаптированные под нужды каждого клиента." },
        { title: "Профессионализм", description: "Опытная команда обеспечивает высокий уровень сервиса и поддержку на каждом этапе." },
      ],
    },
    contact: {
      title: "Свяжитесь с нами",
      subtitle:
        "Готовы начать? Наша команда поможет вам запустить P2P-услуги корпоративного уровня.",
      mapTitle: "Мы на карте",
      pinLabel: "RAKBANK HQ - Рас-Аль-Хайма",
      ctaTitle: "Нужна помощь?",
      ctaDesc: "Наш трейдинг-деск работает 24/7 и готов оперативно обработать ваши срочные запросы.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Роль PEXAH?", a: "Мы выступаем официальным мерчантом на P2P‑рынках: вы создаёте заявку на покупку, а мы обеспечиваем продажу USDT." },
        { q: "Безопасность сделки?", a: "Все операции защищены эскроу механикой биржи и подтверждением KYC." },
        { q: "Каков минимальный лимит сделки?", a: "Минимальный лимит зависит от выбранной биржи и объёма операции. Для точной информации свяжитесь с нашей командой." },
        { q: "Какие криптовалюты доступны для продажи?", a: "В первую очередь мы работаем с USDT (Tether)." },
        { q: "Требуется ли прохождение KYC?", a: "Да, применяются правила KYC той биржи, на которой проводится сделка." },
        { q: "Сколько времени занимает сделка?", a: "После подтверждения оплаты P2P-сделка обычно завершается в течение нескольких минут." },
      ],
    },
  },
};
